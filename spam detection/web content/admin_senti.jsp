...
<div class="inner-block">
 ...
 <%
					...
					<br>
					<h2 align="center">Sentiment Analysis on List of Reviews</h2>
				...
				%>						    
						    	<tr>						    		
						  			...
						  			<td><%=reviewList.get(i).getSentiScore() %></td>
						  			<td><%=reviewList.get(i).getSentiResult() %></td>
						  									  			
						    	</tr>
				<%} %>
                                    </tbody>
                                  </table>
                                  <div><a class="btn btn-primary" href="ReviewSimilarityController">Semantic Analysis</a></div>
                            </div>    
</div>

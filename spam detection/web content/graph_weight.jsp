<%@page import="com.netspam.bean.Features"%>
...
<br>
				...
				<div class="inner-block">
					...
					<br>
					<h2 align="center">Features Weight for NetSpam Framework</h2>
					<div class="table-responsive">
					<%
   							double bstWt=0,etfwt=0,negwt=0,devWt=0,avgWt=0,maxWt=0,pp1Wt=0,resWt=0;
							Features feature = (Features)session.getAttribute("Features");
   							if(feature!=null){
   								bstWt=feature.getBurstiness();
   								etfwt=feature.getEtf();
   								negwt=feature.getNegRatio();
   								devWt=feature.getDeviation();
   								avgWt=feature.getAvgSim();
   								maxWt=feature.getMaxSim();
   								pp1Wt=feature.getPp1();
   								resWt=feature.getRes();
   							}
   	
  					 %>
					
					<div id="weightcontainer" style="height: 400px"></div>

						<div>
							<a class="btn btn-primary" href="graph_result.jsp">Result</a>
						</div>
					</div>
				</div>
				...
				.highcharts(
						{
							...
							title : {
								text : 'NetSpam Framework Features Score'
							},
							subtitle : {
								text : 'Features Weight'
							},
							xAxis : {
								categories : [ 'Features',

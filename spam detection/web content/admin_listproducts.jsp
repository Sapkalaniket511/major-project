...
<%
				...
				%>						    
						    	<tr>
						    		...
						    		<td ><img alt="Product Pic" class="img-square" src="<%=productList.get(i).getImg_url() %>"  width="150px" height="100px"/></td>
						  			<%-- <td><%=productList.get(i).getProduct() %></td> --%>
						  			<td><%=productList.get(i).getItem_id() %></td>
						  			<td><%=productList.get(i).getItem_name() %></td>
						  			<td><%=productList.get(i).getPrice() %></td>
						  			<td><%=productList.get(i).getRating() %></td>
						  			<td><%=productList.get(i).getCategory() %></td>
						  			<td><a class="btn btn-primary" href="AdminExtractReviewController?item_id=<%= productList.get(i).getItem_id()%>">Extract</a></td>						  			
						    	</tr>
				<%} %>
                                    </tbody>
                                  </table>

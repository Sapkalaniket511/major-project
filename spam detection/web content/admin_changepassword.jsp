    	 ...
    	 <div class="login-head">
				<h1>Change your password</h1>
							...
							<div class="login-block">
								<form action="AdminPasswordController?email=<%=emailMsg%>"
									method="post">
									<div class="form-group">
										<label>Old Password</label> <input type="password"
											...
											pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
											title="Password must contain at least one number and one special character and one uppercase and lowercase letter, and at least 8 or more characters"
											required="required">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Retype Password</label> <input type="password"
											...
											onchange="return isPasswordMatch(newpassword1,newpassword2)"
											pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
											title="Password must contain at least one number and one special character and one uppercase and lowercase letter, and at least 8 or more characters"
											required="required">
									</div>

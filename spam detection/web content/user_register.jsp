    	 ...
    	 <div class="signup-head">
			...
			<div class="signup-block">
				<form action="UserRegisterController" method="post" enctype="multipart/form-data">
							...
							<div class="radio">
								<input class="form-control" placeholder="First Name" name="fname" type="text" autofocus="" pattern="[A-Za-z]+" title="Name must be alphabets only" required="required">
							</div>
							<div class="radio">
								<input class="form-control" placeholder="Last Name" name="lname" type="text" pattern="[A-Za-z]+" title="Name must be alphabets only" required="required">
							</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
									...
									<label> <input type="radio" name="gender" value="Male" required="required">
										Male
									</label>
								
									<label> <input type="radio" name="gender" value="Female" required="required">
										Female
									</label>
								
							</div>
							<div class="form-group">
								<textarea class="form-control" placeholder="Address" name="address" rows="2" cols="20"></textarea>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
									...
									<select name="secquesion" class="form-control">
									...
									<option>what is your favorite social media website</option>
									</select>
									<input class="form-control" placeholder="Answer" name="secanswer" type="text" value="">								
							</div>
							<div class="form-group">
				...
				<div class="sign-down">
				<h4>Already have an account? <a href="user.jsp"> Login here.</a></h4>				  
				</div>
			</div>
    </div>
</div>

...
<br>
				...
				<div class="inner-block">
					...
					<br>
					<h2 align="center">Spam Classification for NetSpam Framework</h2>
					<div class="table-responsive" align="center">
					<%
   							double bstWt=0,etfwt=0,negwt=0,devWt=0,avgWt=0,maxWt=0,pp1Wt=0,resWt=0;
							Object ospam = session.getAttribute("SpamReviews");
							Object onspam = session.getAttribute("NonSpamReviews");
   							int spam=Integer.parseInt(ospam.toString());
   							int nonspam=Integer.parseInt(onspam.toString());
   	
  					 %>
					
					<div id="weightcontainer" style="height: 400px;width: 500px"  ></div>
				...
				.highcharts(
						{
							...
							title : {
								text : 'NetSpam Framework Spam Classification'
							},
							subtitle : {
								text : 'Result'
							},

...
<div class="inner-block">
 ...
 <%
					...
					<br>
					<h2 align="center">List of Reviews</h2>
				...
				%>						    
						    	<tr>						    		
						  			...
						  			<td><%=reviewList.get(i).getVerifiedPurchase() %></td>						  			
				...
				<%} %>
                                  ...
                                  <div><a class="btn btn-primary" href="AdminSentimentAnalysisController">Sentiment Analysis</a></div>
                            </div>    
</div>

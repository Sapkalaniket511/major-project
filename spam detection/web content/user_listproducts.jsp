    	...
    	<div class="col-md-4 product-grid">
    		<div class="product-items">
	    		    <div class="project-eff">						     
							<img alt="Product Pic" class="col-md-10" align="middle" src="<%=productList.get(i).getImg_url() %>"/>
					</div>
	    		<div class="produ-cost">
	    			<h4 ><%=productList.get(i).getItem_name() %></h4>
	    			<h5>Price: <%=productList.get(i).getPrice() %></h5>
	    			<h5>Offer: <%=productList.get(i).getOffer() %></h5>
	    			<h5>Discount: <%=productList.get(i).getDiscount() %></h5>
	    			<h5>Rating: <%=productList.get(i).getRating() %></h5>
	    			<h6>Category: <%=productList.get(i).getCategory() %></h6>
	    			<h5 style="color: purple;"><%=productList.get(i).getReviews() %> &nbsp; <a href="ListReviewController?id=<%=productList.get(i).getItem_id()%>">reviews</a></h5>
	    		</div>
    		</div>
    	</div>
    	<%} %>    	

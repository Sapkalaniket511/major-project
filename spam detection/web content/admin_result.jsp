...
<div class="inner-block">
 ...
 <%
					...
					<br>
					<h2 align="center">Spam Detection on List of Reviews</h2>
				...
				%>						    
						    	<tr>						    		
						  			...
						  			<td><%=reviewList.get(i).getClassify() %></td>
						  									  			
						    	</tr>
				<%} %>
                                    </tbody>
                                  </table>
                                  <div><a class="btn btn-primary" href="graph_weight.jsp">Features Weight</a></div>
                            </div>    
</div>
